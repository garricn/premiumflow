...
class TestMultiRollChains(unittest.TestCase):
        ...
        self.multi_roll_txns = [
            {
                ...
                "Trans Code": "STO",
                "Quantity": "1",
                "Description": "IREN 10/17/2025 Call $50.00",
                "Instrument": "IREN",
                "Amount": "$132.96",
                "Price": "$1.33",
            },
            ...
            },
            {
                ...
                "Trans Code": "STO",
                "Quantity": "1",
                "Description": "IREN 11/21/2025 Call $55.00",
                "Instrument": "IREN",
                "Amount": "$390.00",
                "Price": "$3.90",
            },
            {
                "Activity Date": "10/3/2025",
                "Trans Code": "BTC",
                "Quantity": "1",
                "Description": "IREN 11/21/2025 Call $55.00",
                "Instrument": "IREN",
            ...
            },
            {
                ...
                "Trans Code": "STO",
                "Quantity": "1",
                "Description": "IREN 12/19/2025 Call $60.00",
                "Instrument": "IREN",
                "Amount": "$877.00",
                "Price": "$8.77",
            },
            {
                "Activity Date": "10/6/2025",
                "Trans Code": "BTC",
                "Quantity": "1",
                "Description": "IREN 12/19/2025 Call $60.00",
                "Instrument": "IREN",
            ...
            },
            {
                ...
                "Trans Code": "STO",
                "Quantity": "1",
                "Description": "IREN 02/20/2026 Call $70.00",
                "Instrument": "IREN",
                "Amount": "$1325.00",
                "Price": "$13.25",
            },
    ...
    def test_multi_roll_pnl(self):
        ...
        expected_credits = (
            Decimal("132.96") + Decimal("390.00") + Decimal("877.00") + Decimal("1325.00")
        )
    ...
    def test_reexports_legacy_functions(self):
        ...
        for name, reference in expected.items():
            with self.subTest(name=name):
                ...
                self.assertTrue(
                    hasattr(premiumflow, name), f"Function {name} not found in premiumflow package"
                )
                self.assertTrue(
                    callable(getattr(premiumflow, name)), f"Attribute {name} is not callable"
                )
